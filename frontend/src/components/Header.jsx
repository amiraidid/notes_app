    ...
    return (
        <>
                    ...
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        <div className={`items-center justify-between ${show ? 'hidden' : 'block'} w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
                            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <li><NavLink to="get-notes" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Notes</NavLink></li>
                                {
                                    user ? (
            ...
            <div className={`${showUserModal ? 'flex' : 'hidden'} flex-col items-center w-52 p-4 rounded-md bg-slate-200 absolute top-20 right-0 dark:bg-gray-700 shadow-css m-3`}>
                {/* <h1 className="text-2xl px-2 py-1 dark:text-white capitalize">name</h1>
